    ...
    public partial class CreateDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkerOrders", x => new { x.OrdersId, x.WorkersId });
                    table.ForeignKey(
                        name: "FK_WorkerOrders_Orders_OrdersId",
                        column: x => x.OrdersId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkerOrders_Workers_WorkersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkerOrders_WorkersId",
                table: "WorkerOrders",
                column: "WorkersId");
        }
